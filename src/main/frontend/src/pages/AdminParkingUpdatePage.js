        ...
        <div className="APABody">
          <Form onSubmit={handleSubmit} className="parkingForm">
            ...
            <Form.Group className="parkingFormInput" controlId="formName">
              <Form.Label className="parkingFromLabel">
                주차장 이름 *
              </Form.Label>
              <Form.Control
                type="text"
